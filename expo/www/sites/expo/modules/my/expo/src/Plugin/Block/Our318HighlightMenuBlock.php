 ...
 *
 * @Block(
 *   id = "our318_highlight_menu_block",
 *   admin_label = @Translation("Our3l8 Highlight Menu Block"),
 *   category = @Translation("WG")
 * )
 */
class Our318HighlightMenuBlock extends BlockBase {
  ...
  public function build() {
    ...
    $menu = '
            ...
            <li><a href="/p"><i class="fa fa-arrow-circle-left"></i> 我們的318</a></li>
